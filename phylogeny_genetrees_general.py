...
#        al_files = glob.glob(args.indir + '/*.fasta.aln')
        al_files = glob.glob(args.indir + '/*.fasta')
        
        for z in al_files:
                sbpc = 'singularity exec ~/AusARG_Proj/SIF/iqtree_2.1.2--h56fc30b_0.sif iqtree -s %s --quiet -T 1 -B 1000' % z
